...
export default function GoogleCallback() {
    ...
    if (error) {
        return (_jsx("div", { style: {
            ...
            }, children: _jsx(Result, { status: "error", title: "Google \u767B\u5F55\u5931\u8D25", subTitle: errorText, extra: _jsx(Button, { type: "primary", onClick: () => navigate('/login'), style: { background: 'var(--color-primary)', borderColor: 'var(--color-primary)' }, children: "\u8FD4\u56DE\u767B\u5F55" }) }) }));
    }
