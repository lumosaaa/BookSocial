...
function Bubble({ msg, isMine, canRecall, onRecall, showAvatar }) {
    ...
    return (_jsxs("div", { style: {
            ...
            alignItems: 'flex-end',
            gap: 8,
        }, children: [showAvatar ? (_jsx(Avatar, { size: 36, src: msg.senderAvatar || undefined, style: { background: '#4A6741', flexShrink: 0, alignSelf: 'flex-end' }, children: msg.senderName[0]?.toUpperCase() })) : (_jsx("div", { style: { width: 36, flexShrink: 0 } })), _jsxs("div", { style: {
                    display: 'flex',
...
export default function ChatPage() {
    ...
    return (_jsxs("div", { style: {
            ...
            boxShadow: '0 0 12px rgba(0,0,0,0.06)',
                ...
                }, children: [_jsx(Button, { type: "text", icon: _jsx(ArrowLeftOutlined, {}), onClick: () => navigate('/messages'), style: { color: '#666', padding: '0 4px' } }), _jsxs("span", { style: { fontWeight: 600, fontSize: 16, color: '#333', flex: 1, display: 'flex', alignItems: 'center', gap: 8 }, children: [peerName || '私信', peerId && (_jsx("span", { style: {
                                    display: 'inline-block',
                                    width: 8,
                                    height: 8,
                                    borderRadius: '50%',
                                    background: isPeerOnline ? '#52c41a' : '#d9d9d9',
                                }, title: isPeerOnline ? '在线' : '离线' }))] })] }), _jsxs("div", { ref: chatRef, onScroll: (e) => {
                    ...
                    background: '#f7f9f7',
                }, children: [hasMore && loading && page > 1 && (_jsx("div", { style: { textAlign: 'center' }, children: _jsx(Spin, { size: "small" }) })), loading && page === 1 && (_jsx("div", { style: { textAlign: 'center', padding: '60px 0' }, children: _jsx(Spin, {}) })), !loading && messages.length === 0 && (_jsx(Empty, { description: "\u6682\u65E0\u6D88\u606F\uFF0C\u53D1\u4E2A\u62DB\u547C\u5427\uFF5E", style: { marginTop: 60 } })), messages.map((msg, idx) => {
                        ...
                        return (_jsxs(Fragment, { children: [showDay && (_jsx("div", { style: { textAlign: 'center' }, children: _jsx("span", { style: {
                                        ...
                                        }, children: formatDayLabel(msg.createdAt) }) })), _jsx(Bubble, { msg: msg, isMine: isMine, canRecall: canRecall, onRecall: handleRecall, showAvatar: showAvatar })] }, msg.id));
                    }), _jsx("div", { ref: bottomRef })] }), _jsxs("div", { style: {
                    padding: '10px 16px 12px',
                    borderTop: '1px solid #f0f0f0',
                    background: '#fff', flexShrink: 0,
                }, children: [peerTyping && (_jsx("div", { style: { fontSize: 12, color: '#52c41a', paddingBottom: 4 }, children: "\u5BF9\u65B9\u6B63\u5728\u8F93\u5165\u2026" })), _jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'flex-end' }, children: [_jsx(Input.TextArea, { value: inputText, onChange: (e) => {
