...
export default function DiscoverPage() {
    ...
    const tabItems = [
        ...
        },
        {
            key: 'hot',
            label: '热门榜单',
            children: (_jsxs("div", { className: "discover-section", children: [_jsx("h2", { className: "section-title", children: "\uD83D\uDD25 \u8FD1 7 \u5929\u70ED\u95E8\u4E66\u7C4D" }), hotLoading ? (_jsx("div", { className: "loading-center", children: _jsx(Spin, { size: "large" }) })) : hotBooks.length === 0 ? (_jsx(Empty, { description: "\u6682\u65E0\u70ED\u95E8\u6570\u636E" })) : (_jsx("div", { className: "books-grid", children: hotBooks.map((b, idx) => (_jsxs("div", { className: "hot-rank-wrapper", children: [_jsx("span", { className: `rank-badge ${idx < 3 ? 'rank-top' : ''}`, children: idx + 1 }), _jsx(BookRecommendCard, { book: b, onDismiss: dismissHotBook })] }, b.id))) }))] })),
        },
    ];
