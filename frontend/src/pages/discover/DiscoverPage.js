...
function BookRecommendCard({ book, onDismiss, }) {
    ...
    return (_jsxs("div", { className: "discover-book-card", onClick: () => navigate(`/books/${book.id}`), children: [_jsx("button", { className: "dismiss-btn", onClick: e => {
                    e.stopPropagation();
                    onDismiss(book.id);
                }, title: "\u4E0D\u611F\u5174\u8DA3", children: _jsx(CloseOutlined, {}) }), _jsx("div", { className: "book-cover", children: book.coverUrl ? (_jsx("img", { src: book.coverUrl, alt: book.title, loading: "lazy" })) : (_jsx("div", { className: "cover-placeholder", children: _jsx(BookOutlined, {}) })) }), _jsxs("div", { className: "book-info", children: [_jsx("h3", { className: "book-title", children: book.title }), _jsx("p", { className: "book-author", children: book.author }), book.categoryName && _jsx(Tag, { color: "green", children: book.categoryName }), book.platformRating && (_jsxs("div", { className: "book-rating", children: [_jsx(Rate, { disabled: true, allowHalf: true, value: stars, style: { fontSize: 12 } }), _jsx("span", { className: "rating-value", children: (book.platformRating / 2).toFixed(1) })] })), _jsxs("p", { className: "shelf-count", children: [_jsx(BookOutlined, {}), " ", book.shelfCount.toLocaleString(), " \u4EBA\u5728\u8BFB"] })] })] }));
}
// ── 推荐书友卡片 ──────────────────────────────────────────────
